...
BOT_TOKEN = environ.get('BOT_TOKEN', '5569911992:AAEz9VF_xYlMXR0DdnvSon7__GUgRjODDZ4')

# Bot settings
CACHE_TIME = 300
USE_CAPTION_FILTER = False
NOR_IMG = environ.get('NOR_IMG', "https://telegra.ph/file/5e0c5141f5e6e8cd600c2.jpg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6047510747').split()] 
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://cbautobot2:cbautobot2@cluster0.m0lmkto.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "cbautobot2")
...
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/CV_Offical")
...
#Fsub
auth_channel = environ.get('AUTH_CHANNEL', '-1001376597667')
